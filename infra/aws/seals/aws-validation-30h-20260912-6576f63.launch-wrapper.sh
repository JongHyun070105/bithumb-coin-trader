...
worktree="/var/lib/bitcoin-trader/runtime-worktrees/aws-validation-30h-20260912-6576f63"
python="/var/lib/bitcoin-trader/venv-pre-soak/bin/python"

sup_cmd_json=$("$python" -c '
import json
with open("/var/lib/bitcoin-trader/launch-artifacts/aws-validation-30h-20260912-6576f63/aws-validation-30h-20260912-6576f63.launch-command.json") as f:
    d = json.load(f)
