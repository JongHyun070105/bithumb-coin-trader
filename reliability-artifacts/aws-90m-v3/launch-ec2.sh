...
artifacts_dir="/var/lib/bitcoin-trader/launch-artifacts/aws-validation-observability-90m-20260917-20260917T062500Z-v3"
...
exec "$python" "$worktree/scripts/launch_short_smoke_transient.py" \
  --run-id "aws-validation-observability-90m-run-20260917T062500Z-v3" \
  --workdir "$worktree" \
  ...
  --data-dir "/var/lib/bitcoin-trader/90m-validation/aws-validation-observability-90m-20260917-20260917T062500Z-v3" \
  "$@"
