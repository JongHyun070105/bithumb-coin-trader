...
artifacts_dir="/var/lib/bitcoin-trader/launch-artifacts/aws-validation-observability-90m-20260917-20260917T081500Z-v4"
...
if [ "$is_launch" = true ]; then
  obs_unit="bitcoin-trader-obs-aws-validation-observability-90m-run-20260917T081500Z-v4.service"
  echo "[LAUNCH] Pre-starting runtime observer unit $obs_unit to guarantee OBSERVER_START <= COLLECTOR_START..."
  systemd-run \
    --unit="$obs_unit" \
    --description="Runtime Observer for aws-validation-observability-90m-run-20260917T081500Z-v4" \
    --service-type=simple \
    --no-block \
    --property="Environment=PYTHONPATH=$worktree/src" \
    "$python" -m bithumb_coin_trader.runtime_observer \
      --data-dir "/var/lib/bitcoin-trader/90m-validation/aws-validation-observability-90m-20260917-20260917T081500Z-v4" \
      --epoch "aws-validation-observability-90m-20260917-20260917T081500Z-v4" \
      --run-id "aws-validation-observability-90m-run-20260917T081500Z-v4" \
      --unit-name "bitcoin-trader-90m-aws-validation-observability-90m-run-20260917T081500Z-v4.service" \
      --poll-interval 15.0 \
      --s3-publish-interval 60.0 \
      --stale-threshold 30.0 \
      --s3-bucket "bitcoin-trader-aws-apne2-research-ap-northeast-2-080109295433" \
      --s3-prefix "market-data/temporary/aws-validation-observability-90m-20260917-20260917T081500Z-v4" \
      --allow-s3-write
