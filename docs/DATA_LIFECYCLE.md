...
| :--- | :---: | :---: | :--- |
| **DEV (개발)** | 2026-09-12 11:00 ~ 2026-09-13 04:00 | 18시간 | 가설 탐색, 피처 엔지니어링, 메이커/테이커 체결 시뮬레이션 (현재 메이커 및 크로스 익스체인지 연구는 DEV 블록 D1: 2026-09-12 11:00 ~ 16:59 UTC 6시간 슬라이스를 활용함) |
